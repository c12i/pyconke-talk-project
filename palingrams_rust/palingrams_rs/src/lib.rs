...
pub fn find_palingrams(word_list: Vec<String>) -> Vec<(String, String)> {
...
pub fn find_palingrams_concurrent(word_list: Vec<String>) -> Vec<(String, String)> {
...
pub fn load_file_data(path: &'static str) -> Vec<String> {
